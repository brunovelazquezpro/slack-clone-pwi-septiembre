...
/* ahora q tenemos nuestro formulario, como trabajar con un form de react, 
captura elemento de submit 
handleSubmitMessage esta asociada al formulario 
<form onSubmit={handleSubmitMessage}>
siempre recibe como parametro el (evento)
*/
const Chatlist = ({ mensajes }) => {
    const [ error, setError ] = useState({text: '', isError: false}) // personalizamos en error, creamos un objeto del error
    const handleSubmitMessage = (evento) => {
        ...
        if(!mensaje){
            ...
            //Si no hay error entonces devuelvo al estado de error a su valor inicial q seria ({text: '', isError: false})
